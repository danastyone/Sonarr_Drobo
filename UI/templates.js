...
this["T"]["form/textbox"] = {"1":function(depth0,helpers,partials,data) {
  ...
  stack1 = helpers['if'].call(depth0, (depth0 != null ? depth0.unit : depth0), {"name":"if","hash":{},"fn":this.program(3, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  buffer += "\n";
  stack1 = this.invokePartial(partials.FormHelpPartial, '    ', 'FormHelpPartial', depth0, undefined, helpers, partials, data);
  if (stack1 != null) { buffer += stack1; }
...
this["T"]["manualimport/errorview"] = {"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  return "Unable to load files for manual import. Check logs for more details.\n";
  },"useData":true};
...
this["T"]["shared/errorview"] = {"1":function(depth0,helpers,partials,data) {
  var helper, functionType="function", helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression;
  return "  <strong>"
    + escapeExpression(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : helperMissing),(typeof helper === functionType ? helper.call(depth0, {"name":"title","hash":{},"data":data}) : helper)))
    + "</strong>\n";
